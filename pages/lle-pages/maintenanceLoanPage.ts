...
export class MaintenanceLoanPage {
    private page: Page;
    ...
    private maintenanceLoanTitle: Locator;
    private checkDetailsTitle: Locator;

    constructor(page: Page) {
        this.page = page;
        this.maintenanceLoanTitle = this.page.getByRole('heading', { name: 'Maintenance Loan', exact: true });
    ...
    @step('Fill Maintenance Loan steps')
    async fillMaintenanceLoanSteps(){
        await expect(this.maintenanceLoanTitle).toBeVisible({ timeout: 20000 });
